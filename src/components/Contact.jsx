...
const socialLinks = [
  ...
  const contactLinks = [
    {
      href: 'https://wa.me/+2349030995027',
      icons: <svg
      ...
      className="w-6 h-6"
      >
      <path d="M380.9 97.1C339 55.1 283.2 32 224 32 100.3 32 0 132.3 0 256c0 45 11.9 88.7 34.5 127.1L0 480l99.5-33.1c36.8 20.1 78.4 30.8 120.5 30.8h.1c123.7 0 224-100.3 224-224 0-59.2-23.1-115-65.1-157zM224.1 438.4c-37.2 0-73.5-10-105.3-29l-7.5-4.5-59 19.6 19.6-57.6-4.9-7.9C50.2 327.3 40 292.2 40 256c0-101.7 82.4-184.1 184.1-184.1 49.2 0 95.4 19.1 130.1 53.8 34.7 34.7 53.8 80.9 53.8 130.1 0 101.7-82.4 184.1-184 184.1zm101.6-138.1c-5.5-2.8-32.5-16-37.6-17.8-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.4 17.8-17.6 21.5-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.2 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.3-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2s-9.7 1.4-14.8 6.9c-5.1 5.6-19.4 18.9-19.4 46s19.9 53.4 22.6 57.1c2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.4 32.5-13.2 37.1-26 4.6-12.8 4.6-23.7 3.2-26.1-1.3-2.4-5-3.7-10.5-6.5z" /> 
      </svg>,
      alt: 'WhatsApp'
    },
    {
      href: 'tel:+2349053338083',
      icons: <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
      fill="currentColor"
      className="w-6 h-6"
    >
      <path d="M511.7 387.3c1.3 4.6.3 9.5-2.7 13.2l-81 99.4c-3.7 4.6-9.5 6.6-15.2 5.2-66-15.5-132.5-50.7-190.3-108.5C164.6 338.8 129.4 272.3 113.9 206.3c-1.5-5.8.5-11.6 5.2-15.2l99.4-81c3.7-3 8.6-4 13.2-2.7 4.6 1.3 8.2 4.8 9.5 9.4l30.2 112.4c1.3 4.8-.1 9.9-3.7 13.4l-40.3 40.3c29.2 55.1 72.6 98.5 127.7 127.7l40.3-40.3c3.6-3.6 8.7-5 13.4-3.7l112.4 30.2c4.6 1.3 8.1 4.9 9.4 9.5z"/>
    </svg>,
      alt: 'Call'
    },
  ];
    ...
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch lg:mt-28 mt-20 ">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 lg:mb-8 mb-4 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                    Reach out today to discuss your project needs and start collaborating on something amazing!
                </p>
                <div className="flex items-center gap-3 mt-auto mb-5">
                    {contactLinks.map(({href, icons,alt }, key) => (
                        <a
                        key={key}
                        href={href}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 px-4 py-2 ring-inset ring-2 ring-zinc-50/5 
                                  transition-all hover:bg-zinc-50 rounded-lg hover:text-zinc-950 
                                  active:bg-zinc-50/80 reveal-up"
                      >
                        <span className="w-6 h-6">{icons}</span>
